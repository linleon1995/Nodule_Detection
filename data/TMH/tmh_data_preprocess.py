...
from data.TMH import medical_to_img, tmh_data_merge
...
DATASET_NAME = 'TMH-Nodule' # Benign, Malignant, LUNA16, LUNA16-Round


def remove_1m0045_noise():
    # load data
    data_path = rf'C:\Users\test\Desktop\Leon\Datasets\TMH_Nodule\1m0045\1m0045mask mhd\1.2.826.0.1.3680043.2.1125.1.34712572629822057263533271989332452.mhd'
